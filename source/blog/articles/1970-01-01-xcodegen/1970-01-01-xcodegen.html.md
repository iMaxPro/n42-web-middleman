...
Create a `project.yml` file with the following content in the root:
...
targets: # The List of our targets
  XcodegenApp:
    ...
    settings:
      ...
      PRODUCT_BUNDLE_IDENTIFIER: "de.number42.XcodegenApp"
      PRODUCT_NAME: "XcodegenApp"
      INFOPLIST_FILE: "XcodegenApp/Info.plist"
```
...
XcodegenApp-iOS-Tests:
  ...
  platform: iOS
  settings:
    TEST_HOST: "$(BUILT_PRODUCTS_DIR)/XcodegenApp.app/XcodegenApp"
    IPHONEOS_DEPLOYMENT_TARGET: 10.3 # What version of iOS do we target?
  sources:
...
1.  Create a folder "XcodegenAppCore"
...
4.  Add this target to the `project.yml`:
    ...
    XcodegenAppCore:
        ...
        settings:
          IPHONEOS_DEPLOYMENT_TARGET: 10.3
          PRODUCT_BUNDLE_IDENTIFIER: "de.number42.XcodegenApp.core"
        sources:
