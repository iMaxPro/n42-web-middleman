...
# iOS Projects done right: How to manage the ruby environment of your iOS Project using rbenv

In the series "iOS Projects done right", we have a look at the various tools and environments that are useful to have a more convenient and efficient handling of iOS Projects.
...
<pre><code class="language-bash">brew install rbenv</code></pre>

this will also install _ruby-build_ tool (for installing versions of _ruby_ via _rbenv_)

If you are upgrading run

<pre><code class="language-bash">brew upgrade rbenv ruby-build</code></pre>
...
<pre><code class="language-bash">echo $0</code></pre>
...
<pre><code class="language-bash">eval "$(rbenv init -)"</code></pre>
...
<pre><code class="language-bash">rbenv help</code></pre>
...
<pre><code class="language-bash">rbenv local 2.5.1</code></pre>
...
<pre><code class="language-bash"># List of gems used in this project
gem "cocoapods", "~> 1.5"
</code></pre>
...
<pre><code class="language-bash">bundle init</code></pre>

To add a first dependency, you can run `bundle add <Gemname>`, e.g.

<pre><code class="language-bash">bundle add fastlane</code></pre>
...
<pre><code class="language-bash">bundle exec fastlane</code></pre>
